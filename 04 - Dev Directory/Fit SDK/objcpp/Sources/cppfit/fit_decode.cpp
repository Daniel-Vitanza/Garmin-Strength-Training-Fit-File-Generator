...
FIT_BOOL Decode::Read(std::istream* file, void* objcppCaller)
{
    this->objcppCaller = objcppCaller;

    return Read(file, nullptr, nullptr, nullptr);
}
    ...
    do
    {
        ...
        for (; currentByteIndex < bytesRead; currentByteIndex++)
        {
            ...
            switch (decodeReturn) {
                ...
                case RETURN_MESG:
                    ...
                    else if (mesg.GetNum() == FIT_MESG_NUM_FIELD_DESCRIPTION)
                    {
                        ...
                        try
                        {
                            ...
                            OnDeveloperFieldDefinitionFromDecoder(objcppCaller, &descMesg, &developers[index]);
                    ...
                    OnMesgFromDecoder(objcppCaller,&mesg);
                ...
                case RETURN_MESG_DEF:
                   OnMesgDefinitionFromDecoder(objcppCaller, &localMesgDefs[localMesgIndex]);
