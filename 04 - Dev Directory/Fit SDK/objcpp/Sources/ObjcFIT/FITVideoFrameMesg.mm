...
@implementation FITVideoFrameMesg

- (instancetype)init {
    self = [super initWithFitMesgIndex:fit::Profile::MESG_VIDEO_FRAME];
...
- (void)setFrameNumber:(FITUInt32)frameNumber {
    [super setFieldUINT32ValueForField:1 andValue:(frameNumber) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
