...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateDiveSettingsMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("CcrLowSetpointSwitchMode", 22, 0, 1, 0, "", false, Type.CcrSetpointSwitchMode));
            fieldIndex++;
            newMesg.SetField(new Field("CcrLowSetpoint", 23, 2, 100, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("CcrLowSetpointDepth", 24, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("CcrHighSetpointSwitchMode", 25, 0, 1, 0, "", false, Type.CcrSetpointSwitchMode));
            fieldIndex++;
            newMesg.SetField(new Field("CcrHighSetpoint", 26, 2, 100, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("CcrHighSetpointDepth", 27, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("GasConsumptionDisplay", 29, 0, 1, 0, "", false, Type.GasConsumptionRateType));
            fieldIndex++;
            newMesg.SetField(new Field("UpKeyEnabled", 30, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("DiveSounds", 35, 0, 1, 0, "", false, Type.Tone));
            fieldIndex++;
            newMesg.SetField(new Field("LastStopMultiple", 36, 2, 10, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("NoFlyTimeMode", 37, 0, 1, 0, "", false, Type.NoFlyTimeMode));
            fieldIndex++;
        ...
        private static Mesg CreateDiveAlarmMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Id", 6, 134, 1, 0, "", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("PopupEnabled", 7, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("TriggerOnDescent", 8, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("TriggerOnAscent", 9, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("Repeating", 10, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("Speed", 11, 133, 1000, 0, "mps", false, Type.Sint32));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateDiveApneaAlarmMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("DiveApneaAlarm", MesgNum.DiveApneaAlarm);
            fieldIndex = 0;
            newMesg.SetField(new Field("MessageIndex", 254, 132, 1, 0, "", false, Type.MessageIndex));
            fieldIndex++;
            newMesg.SetField(new Field("Depth", 0, 134, 1000, 0, "m", false, Type.Uint32));
        ...
        private static Mesg CreateDiveGasMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Mode", 3, 0, 1, 0, "", false, Type.DiveGasMode));
            fieldIndex++;
        ...
        private static Mesg CreateSessionMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgDepth", 140, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxDepth", 141, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("SurfaceInterval", 142, 134, 1, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("StartCns", 143, 2, 1, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("EndCns", 144, 2, 1, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("StartN2", 145, 132, 1, 0, "percent", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("O2Toxicity", 155, 132, 1, 0, "OTUs", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("DiveNumber", 156, 134, 1, 0, "", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateLapMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgDepth", 122, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxDepth", 123, 134, 1000, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MinTemperature", 124, 1, 1, 0, "C", false, Type.Sint8));
            fieldIndex++;
        ...
        private static Mesg CreateRecordMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AirTimeRemaining", 123, 134, 1, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("PressureSac", 124, 132, 100, 0, "bar/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("VolumeSac", 125, 132, 100, 0, "L/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Rmv", 126, 132, 100, 0, "L/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AscentRate", 127, 133, 1000, 0, "m/s", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("Po2", 129, 2, 100, 0, "percent", false, Type.Uint8));
            fieldIndex++;
        ...
        private static Mesg CreateDiveSummaryMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgPressureSac", 12, 132, 100, 0, "bar/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVolumeSac", 13, 132, 100, 0, "L/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgRmv", 14, 132, 100, 0, "L/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("DescentTime", 15, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AscentTime", 16, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateTankUpdateMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("TankUpdate", MesgNum.TankUpdate);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Sensor", 0, 140, 1, 0, "", false, Type.AntChannelId));
            fieldIndex++;
            newMesg.SetField(new Field("Pressure", 1, 132, 100, 0, "bar", false, Type.Uint16));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateTankSummaryMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("TankSummary", MesgNum.TankSummary);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Sensor", 0, 140, 1, 0, "", false, Type.AntChannelId));
            fieldIndex++;
            newMesg.SetField(new Field("StartPressure", 1, 132, 100, 0, "bar", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("EndPressure", 2, 132, 100, 0, "bar", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("VolumeUsed", 3, 134, 100, 0, "L", false, Type.Uint32));
            fieldIndex++;
